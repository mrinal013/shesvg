<?php
namespace Shesvg_Elementor_Addon;
...
final class Plugin {
     ...
     * @access private
     * @static
     * @var \Shesvg_Elementor_Addon\Plugin The single instance of the class.
     */
     ...
     * @access public
     * @static
     * @return \Shesvg_Elementor_Addon\Plugin An instance of the class.
     */
    ...
    public function register_widgets( $widgets_manager ) {
        ...
        require_once( __DIR__ . '/widgets/shesvg-widget.php' );

        $widgets_manager->register( new \Shesvg_Widget() );
